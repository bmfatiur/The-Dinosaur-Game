...
//  Modified by: Asif Imtiaz Shaafi
...
///modified things: Additional iSetTimer
...
int iSetTimer(int msec, void(*f)(void))
{
	...
	if (iAnimCount >= 30){ printf("Error: Maximum number of already timer used.\n"); return -1; }
